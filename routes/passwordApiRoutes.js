...
const {validateResetTokenFromBody} = require('../middlewares/validateResetToken');
...
router.post('/reset-password', validateResetTokenFromBody, passwordController.resetPassword);
